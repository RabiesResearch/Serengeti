...
### Summary
Please `r embed_data(district="Serengeti", label="click here")` to download an .xlsx file that gives a summary of probable animal cases and human exposures in Serengeti District from 2002 to `r substr(Sys.Date(), 1,4)`.
